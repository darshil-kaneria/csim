...
namespace csim
{
    ...
    void CPUS::setCaches(SnoopCaches *caches)
    {
        caches_ = caches;
    }

    CPUS::CPUS(TraceReader *trace_reader, size_t num_procs, SnoopCaches *caches) : trace_reader_(trace_reader), num_procs_(num_procs), caches_(caches)
    {
